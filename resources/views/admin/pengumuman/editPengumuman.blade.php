                        ...
                        <div class="card-body">
                            <form action="{{route('admin.pengumuman.update')}}" method="POST" enctype=multipart/form-data>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="textarea" rows="3" name="desc" id="desc" class="form-control" value="{{isset($pengumuman->desc) ?$pengumuman->title : '-'}}">
                                </div>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="{{asset($file->link}}" style="display:block;" width="100%" height="100%"></td>
