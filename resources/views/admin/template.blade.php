    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item {{Request::segment(2) == 'keluhan' ? 'menu-open' : ''}}">
          ...
          <li class="nav-item {{Request::segment(2) == 'mikrotik' ? 'menu-open' : ''}}">
            ...
            <ul class="nav nav-treeview">
              ...
              <!-- <li class="nav-item">
                <a href="{{route('admin.mikrotik.listLoadBalancing')}}" class="nav-link {{Request::segment(3) == 'loadBalancing' ? 'active' : ''}}">
